...
2. Start up R Studio, and then install these packages: `sf`, `stars`, and `rnaturalearth`.
...
1. Let's try the easy way first. In RStudio, try installing these R packages: `sf`, `stars`, and `rnaturalearth`. If prompted about installing from binary or from source, choose binary or answer "N" to installing from source.
...
5. Open up R Studio, install these packages: `sf`, `maps`, `maptools`, `rgeos`, and `rnaturalearth`.
