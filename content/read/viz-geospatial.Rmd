...
1. Let's try the easy way first. In RStudio, try installing these R packages: `sf`, `stars`, `rgeos`, and `rnaturalearth`. If prompted about installing from binary or from source, choose binary or answer "N" to installing from source.
