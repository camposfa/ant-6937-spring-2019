...
<span style="color:red">**Due date: Apr. 21 by the end of the day (11:59:59 pm)**</span>

## Introduction

In this small project, you will again think of conceptual questions to ask of one or more data sets.

**There are various options for the data sets.**

1. You can use one or more of the data sets listed below.

2. You can bring your own data set, but if you choose this option, bear in mind that your final project asks you to find a data set related to your theis or interests, and any plots you make for this small project should not be duplicated in the final project.
