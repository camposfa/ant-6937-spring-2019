...
Reshape the `earnings` data so that it has the following columns (variables): `School`, `Gap`, `Gender` and `Pay`. Then, fill in the blanks to set aesthetic mappings to produce the plot.
